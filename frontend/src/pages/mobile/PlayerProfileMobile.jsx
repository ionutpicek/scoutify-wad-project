        ...
        <div style={{ backgroundColor:"#fff", overflowX: "hidden", boxSizing: "border-box", width:"100vw", height:"100vh" }}>
            ...
            <div style={{margin:"1vh 2vw", display:"flex", flexWrap:"wrap",flexDirection:"row", alignItems:"center", justifyContent:"space-around"}}>
                ...
                <div style={{display:"flex", flexDirection:"row", alignItems:"center", justifyContent:"space-around", width:"100%"}}>
                  <img src={playerData.photoURL || profilePhoto}
                      style={{width:"30vw", borderRadius:"30%", height:"30vw", display:"flex"}}>
                  </img> 

                  <div style={{display:"flex", flexDirection:"column"}}>
                    <p style={{marginBottom:"0.1vh"}}>Name: {playerData.name}</p>
                    <p style={{marginBottom:"0.1vh"}}>Nationality: {playerData.nationality}</p>
                    <p style={{marginBottom:"0.1vh"}}>Age: {getAge()}</p>
                    <button
                    ...
                    >
                      {downloadingCv ? "Preparing PDF..." : "Download Player CV"}
                    </button>
                    {cvMessage ? (
                      <p
                        style={{
                ...
                <div style={{display:"flex", flexDirection:"row", justifyContent:"space-around", alignItems:"center", width:"100%"}}>
                  <div style={{display:"flex", flexDirection:"column"}}>
                    <p style={{marginBottom:"0.1vh"}}>{teamName}</p>
                    <p style={{marginBottom:"0.1vh"}}>{statsInfoText}</p>
                    <p style={{marginBottom:"0.1vh"}}>{statsPeriodText}</p>
                  </div>
                  <img src={teamPhoto}
                    style={{width:"25vw", borderRadius:"90%", height:"25vw", objectFit:"cover"}}>
                  </img>
                </div>
            </div>
            ...
            {statsAvailable ? (
              <>
                ...
                >
                  <label htmlFor="player-insight-language-mobile" style={{ color: "#444", fontSize: 12, fontWeight: 600 }}>
                    Prefered Language
                  </label>
                  <select
                    id="player-insight-language-mobile"
                ...
                <div style={{
                  ...
                  <p style={{ margin: "0 0 10px 0", color: "#666", fontSize: 12, lineHeight: 1.45 }}>
                    ...
                    <div style={{
                      ...
                      {[
                        ...
                        >
                          ...
                          <div style={{ fontSize: 15, color: "#111827", fontWeight: 700, lineHeight: 1.2 }}>
                            {value}
                          </div>
                        </div>
                      ))}
