...
import PlayerStatsProccessing from "../services/readAllStats.jsx"
...
const PlayerStats = () => {
    ...
    const handleFileChange = (e) => {
        const uploadedFile = e.target.files?.[0];  // safeguard
    ...
    const handleSubmit = () => {
        ...
        setFileStatus(false);
        setFile(null);
            PlayerStatsProccessing(file); // You already import this
        };
    ...
    return (
        <div style={{height:"100vh", width:"100vw", backgroundColor:"#fff", display:"flex", flexDirection:"column"}}>
            <Header
                ...
                subtitle="Add or update season stats (minutes, games, metrics)."
                onBack={() => navigate(-1)}
            ...
            <div style={{flex: 1, display: "flex", justifyContent: "center", alignItems: "center"}}>
                <div style={{
                    ...
                    <div style={{borderRadius:"4px", gap:10,
                        ...
                        {!fileStatus ? (
                            <p style={{color:"#000", marginLeft:"5vw"}}>Please provide the excel file before submitting (.xlsx/.xls)</p>
                        ) : (null)
                        }
                    </div>
                </div>
